    ...
    <div className="flex flex-col items-center">
      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          ...
          <Link to="/login" className="inline-block bg-white text-blue-700 px-8 py-3 rounded-full font-bold text-lg hover:bg-blue-50 transition-colors shadow-lg">
      ...
      <section className="py-20 px-4 w-full max-w-7xl mx-auto text-center">
        <h2 className="text-3xl font-bold mb-12 text-slate-800">Kenapa Memilih Laku AC?</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
            ...
            <p className="text-slate-600">Teknisi kami datang sesuai jadwal yang telah disepakati bersama.</p>
          </div>
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
            <div className="w-12 h-12 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center mx-auto mb-4">
              <User size={24} />
            ...
            <p className="text-slate-600">Dikerjakan oleh teknisi ahli yang tersertifikasi di bidang mesin pendingin.</p>
          </div>
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
            <div className="w-12 h-12 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center mx-auto mb-4">
              <CheckCircle size={24} />
            ...
            <p className="text-slate-600">Memberikan garansi pengerjaan untuk kenyamanan Anda.</p>
          </div>
        </div>
      </section>

      {/* Jangkauan Area Layanan Section */}
      <section className="py-16 px-4 w-full bg-slate-50 border-y border-slate-200/70">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {primaryAreas.map((area, idx) => (
              <div
                key={idx}
                className="bg-white p-5 rounded-2xl border border-slate-200/80 shadow-sm hover:border-blue-300 hover:shadow-md transition-all group"
              >
                ...
                <Link
                  to="/layanan#area-jabodetabek"
                  className="text-xs font-semibold text-blue-600 hover:text-blue-800 inline-flex items-center gap-1 group-hover:underline"
                >
          ...
          <div className="mt-8 p-4 rounded-2xl bg-blue-50/80 border border-blue-100 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs sm:text-sm text-blue-900 font-medium">
            <div className="flex items-center gap-2.5">
              <ShieldCheck size={20} className="text-blue-600 shrink-0" />
              <span>Bebas ongkos jalan / biaya transportasi untuk radius 10 km dari pos teknisi siaga terdekat.</span>
            </div>
            <Link to="/layanan#area-jabodetabek" className="text-blue-700 hover:underline font-bold whitespace-nowrap">
      ...
      <section className="py-20 px-4 w-full bg-slate-100 text-center">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold mb-4 text-slate-800">Apa Kata Pelanggan Kami?</h2>
          <p className="text-slate-600 mb-12">Ulasan dan kepuasan pelanggan terhadap layanan Laku AC.</p>
              ...
              <div key={index} className="bg-white p-6 rounded-xl shadow-sm relative">
                ...
                <div className="flex items-center gap-3 border-t border-slate-100 pt-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500">Pelanggan di {item.location}</p>
                  </div>
                </div>
              </div>
            ))}
