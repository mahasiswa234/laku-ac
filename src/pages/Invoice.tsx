...
export default function Invoice() {
    ...
    return (
      <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex items-center justify-center p-4">
        <div className="text-center space-y-3">
          ...
          <p className="text-sm font-semibold text-slate-600 dark:text-slate-400">Memuat rincian tagihan & status invoice...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex items-center justify-center p-4">
        <div className="bg-white dark:bg-slate-900 p-8 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 max-w-md w-full text-center space-y-4">
          ...
          <h2 className="text-xl font-bold text-slate-800 dark:text-slate-200">Invoice Tidak Ditemukan</h2>
  ...
  return (
    <div className="min-h-screen bg-slate-100/70 dark:bg-slate-900 py-8 px-4 font-sans text-slate-800 dark:text-slate-200 print:bg-white dark:print:bg-slate-900 print:p-0">
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <div className="bg-white dark:bg-slate-900 p-8 sm:p-12 rounded-3xl shadow-sm border border-slate-200/80 dark:border-slate-800 relative print:shadow-none print:border-none print:p-0 print:rounded-none">
          ...
          {isPaid && (
            <div className="absolute right-10 top-24 pointer-events-none select-none opacity-20 border-4 border-emerald-600 text-emerald-700 dark:text-emerald-300 px-6 py-2 rounded-2xl rotate-[-12deg] font-black tracking-widest text-2xl uppercase print:opacity-30">
              LUNAS / PAID
            </div>
          )}
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start border-b-2 border-slate-100 dark:border-slate-800 pb-8 gap-6">
            ...
            <div className="text-left sm:text-right w-full sm:w-auto pt-2 sm:pt-0 border-t sm:border-t-0 border-slate-100 dark:border-slate-800">
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400 mt-1 flex items-center sm:justify-end gap-1">
                <Calendar size={13} />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 my-8 py-2">
            <div className="bg-slate-50/70 dark:bg-slate-950 p-4 rounded-2xl border border-slate-100 dark:border-slate-800">
              ...
              <p className="font-bold text-slate-800 dark:text-slate-200 text-base">{invoice.customer}</p>
            ...
            <div className="bg-slate-50/70 dark:bg-slate-950 p-4 rounded-2xl border border-slate-100 dark:border-slate-800">
              ...
              <table className="text-xs w-full">
                <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                  <tr>
                    <td className="py-1 text-slate-500 dark:text-slate-400">Unit AC</td>
                    <td className="py-1 font-semibold text-slate-800 dark:text-slate-200 text-right">
                      {invoice.ac_brand || 'AC'} ({invoice.ac_type || 'AC Split'})
                    </td>
                  </tr>
                  <tr>
                    <td className="py-1 text-slate-500 dark:text-slate-400">Lokasi Unit</td>
                    <td className="py-1 font-medium text-slate-700 dark:text-slate-300 text-right">
                      {invoice.ac_location || 'Ruang Servis'}
                    </td>
                  </tr>
                  <tr>
                    <td className="py-1 text-slate-500 dark:text-slate-400">Teknisi Bertugas</td>
                    <td className="py-1 font-semibold text-slate-800 dark:text-slate-200 text-right">
                      {invoice.technician_name || 'Belum ditugaskan'}
                    </td>
                  </tr>
                  <tr>
                    <td className="py-1 text-slate-500 dark:text-slate-400">Jadwal Servis</td>
                    <td className="py-1 font-medium text-slate-700 dark:text-slate-300 text-right">
                      {invoice.date}
                    </td>
                  </tr>
                  <tr>
                    <td className="py-1 text-slate-500 dark:text-slate-400">Status Servis</td>
                    <td className="py-1 text-right">
                      <span className={`px-2 py-0.5 rounded-md text-[11px] font-bold inline-block ${
                        invoice.status === 'Selesai' ? 'bg-emerald-100 dark:bg-emerald-900/30 text-emerald-800 dark:text-emerald-300' :
                        invoice.status === 'Diproses' ? 'bg-purple-100 dark:bg-purple-900/30 text-purple-800 dark:text-purple-300' :
            ...
            <div className="border border-slate-200 dark:border-slate-800 rounded-2xl overflow-hidden">
              <table className="w-full text-left border-collapse">
                ...
                <tbody className="text-xs divide-y divide-slate-100 dark:divide-slate-800">
                  ...
                  <tr>
                    <td className="py-3.5 px-4">
                      <p className="font-bold text-slate-800 dark:text-slate-200 text-sm">{invoice.service}</p>
                      <p className="text-[11px] text-slate-500 dark:text-slate-400 mt-0.5">
                        Layanan servis pada unit {invoice.ac_brand || 'AC'} ({invoice.ac_location || 'Lokasi Terdaftar'})
                      </p>
                    </td>
                    <td className="py-3.5 px-4 text-center font-medium text-slate-700 dark:text-slate-300">1 unit</td>
                  ...
                  {additionalCost > 0 && (
                    <tr className="bg-blue-50/20 dark:bg-blue-900/30">
                      <td className="py-3.5 px-4">
                      ...
                      <td className="py-3.5 px-4 text-center font-medium text-slate-700 dark:text-slate-300">1 paket</td>
                      <td className="py-3.5 px-4 text-right text-slate-700 dark:text-slate-300">
                ...
                <tfoot className="bg-slate-50/50 dark:bg-slate-950 text-xs border-t-2 border-slate-200 dark:border-slate-800">
                  <tr>
                    <td colSpan={3} className="py-2.5 px-4 text-right font-semibold text-slate-600 dark:text-slate-400">
                      Subtotal
                    </td>
                  ...
                  <tr>
                    ...
                    <td className="py-2.5 px-4 text-right font-semibold text-emerald-700 dark:text-emerald-300">
                      Gratis (Termasuk)
                    </td>
                  </tr>
                  <tr className="border-t border-slate-300 dark:border-slate-700 bg-blue-50/40 dark:bg-blue-900/30">
                    <td colSpan={3} className="py-3.5 px-4 text-right font-black text-sm text-slate-800 dark:text-slate-200 uppercase tracking-wide">
                      TOTAL TAGIHAN
                    </td>
                    <td className="py-3.5 px-4 text-right font-black text-base text-blue-700 dark:text-blue-300">
          ...
          <div className="border border-slate-200 dark:border-slate-800 rounded-2xl p-5 mb-8 bg-slate-50/60 dark:bg-slate-950">
            ...
            {isPaid ? (
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 bg-emerald-50 dark:bg-emerald-900/30 border border-emerald-200 dark:border-emerald-800 p-4 rounded-xl">
                <div className="flex items-start gap-3">
                  <div className="p-2 bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-300 rounded-xl shrink-0 mt-0.5">
                    <CheckCircle size={22} />
                  </div>
                  <div>
                    ...
                    <p className="text-xs text-emerald-900 dark:text-emerald-300 mt-1 font-medium">
                      Metode: <strong className="text-slate-800 dark:text-slate-200">{invoice.payment_method || 'Tunai (Cash)'}</strong>
                    </p>
                ...
                <div className="text-left sm:text-right border-t sm:border-t-0 pt-2 sm:pt-0 border-emerald-200 dark:border-emerald-800 w-full sm:w-auto">
                  <div className="flex items-center sm:justify-end gap-1 text-emerald-800 dark:text-emerald-300 text-xs font-bold">
              ...
              <div className="bg-amber-50 dark:bg-amber-900/30 border border-amber-300 dark:border-amber-700 p-4 rounded-xl flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                <div className="flex items-start gap-3">
                  <div className="p-2 bg-amber-200 dark:bg-amber-900/30 text-amber-900 dark:text-amber-300 rounded-xl shrink-0 mt-0.5">
                    <Clock size={20} />
                  </div>
                  <div>
                    ...
                    {invoice.payment_notes && (
                      <p className="text-[11px] text-amber-800 dark:text-amber-300 mt-1 italic">
                ...
                {invoice.payment_proof_url && (
                  <a
                    ...
                    className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-amber-100 dark:bg-amber-900/30 hover:bg-amber-200 dark:hover:bg-amber-900/30 text-amber-900 dark:text-amber-300 text-xs font-bold rounded-lg border border-amber-300 dark:border-amber-700 transition-colors whitespace-nowrap"
                  >
              ...
              <div className="bg-rose-50 dark:bg-rose-900/30 border border-rose-200 dark:border-rose-800 p-4 rounded-xl flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                <div className="flex items-start gap-3">
                  <div className="p-2 bg-rose-100 dark:bg-rose-900/30 text-rose-700 dark:text-rose-300 rounded-xl shrink-0 mt-0.5">
                    <AlertCircle size={20} />
                  </div>
                  <div>
            ...
            <div className="border-t border-slate-200 dark:border-slate-800 pt-6 mb-8 print:break-inside-avoid">
              ...
              <div className="grid grid-cols-2 gap-4">
                {invoice.before_photo_url && (
                  <div>
                    <p className="text-[11px] font-semibold text-slate-500 dark:text-slate-400 mb-1">Foto Sebelum Servis:</p>
                    <img 
                ...
                {invoice.after_photo_url && (
                  <div>
                    <p className="text-[11px] font-semibold text-slate-500 dark:text-slate-400 mb-1">Foto Setelah Servis:</p>
                    <img 
          ...
          <div className="grid grid-cols-2 gap-8 border-t border-slate-200 dark:border-slate-800 pt-8 mt-10 text-center text-xs text-slate-600 dark:text-slate-400 print:break-inside-avoid">
            <div>
              ...
              <p className="font-bold text-slate-800 dark:text-slate-200 mt-1">{invoice.customer}</p>
            </div>
            <div>
              <p className="text-slate-400 font-medium mb-16">Teknisi / Petugas Servis</p>
              <div className="w-36 border-b border-slate-400 dark:border-slate-600 mx-auto"></div>
              <p className="font-bold text-slate-800 dark:text-slate-200 mt-1">{invoice.technician_name || 'Teknisi AC'}</p>
            </div>
          </div>
